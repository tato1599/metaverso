...
class DemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $uMaestro = Usuario::create(['id_rol' => $roles['Maestro'], 'correo' => 'maestro@tecnm.mx', 'contrasena_hash' => Hash::make('password'), 'nombre' => 'Laura', 'apellidos' => 'Gómez']);
        ...
        foreach ([['Ana', 'Ruiz', '20250001'], ['Beto', 'Díaz', '20250002'], ['Caro', 'León', '20250003']] as [$nom,$ape,$mat]) {
            $u = Usuario::create(['id_rol' => $roles['Alumno'], 'correo' => strtolower($nom).'@tecnm.mx', 'contrasena_hash' => Hash::make('password'), 'nombre' => $nom, 'apellidos' => $ape]);
